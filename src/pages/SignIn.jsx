            ...
            <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
                ...
                <div className='w-full md:w-[40%] lg:w[40%] lg:ml-20'>
                    <form>
                        ...
                        <button className='w-full px-7 py-3 text-sm font-medium uppercase text-white bg-blue-600 rounded shadow-md hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800' type='submit'>Sign in
                    </button>
